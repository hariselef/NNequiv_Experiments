...
def calc_experiment(nn1, nn2, eq_type, dataset):
    ...
    NN1_w1, NN1_b1, NN1_w2, NN1_b2, NN1_w3, NN1_b3 = model_1.get_weights()
    ...
    NN1_w3 = NN1_w3.tolist()
    NN1_b3 = NN1_b3.tolist()
    ...
    w_1_3 = list_to_RealVal(NN1_w3)
    b_1_3 = list_to_RealVal(NN1_b3)
    ...
    def NN_1(x):
        ...
        a2 = Relu(z2)
        z3 = vec_add(vec_mat_mul(w_1_3, a2), b_1_3)
        return z3
...
if __name__ == "__main__":
    ...
    directory = 'models/Sanity_Check/BitVec/arch_2/'
    ...
    for nn in NN:
        ...
        for eq in eq_types:
            calc_experiment(nn, nn, eq, "BitVec")
