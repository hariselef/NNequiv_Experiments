...
if __name__ == "__main__":
    ...
    model_1_path = 'models/Equivalence_Checking/BitVec/arch_1/'
    model_2_path = 'models/Equivalence_Checking/BitVec/arch_2/'

    NN1 = model_pool(model_1_path)
    NN2 = model_pool(model_2_path)
    ...
    for (nn1, nn2) in zip(NN1, NN2):

        eq_types = [ "strict", "L1", "Linf", "argmax"]
    
        for eq in eq_types:
            calc_experiment(nn1, nn2, eq, "BitVec")
